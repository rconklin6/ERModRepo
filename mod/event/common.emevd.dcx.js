...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 10051, 0);
    InitializeEvent(0, 10052, 0);
    InitializeEvent(0, 10053 0);
...
$Event(10050, Default, function() {
    // Other Roar
    WaitFor(CharacterHasSpEffect(10000, 321902));
    SetSpEffect(10000, 321903); 
        RestartEvent();
});
    
    $Event(10051 Default, function() {
    // Other Roar Removal
    WaitFor(CharacterHasSpEffect(10000, 321902, 0, 1));
    ClearSpEffect(10000, 321903);
    RestartEvent();
});
